---
title: Zuckerberg Is Copying Dorsey. The Receipts Are Timestamped.
date: 2026-03-23
category: Field Note
slug: zuckerberg-copying-dorsey
lede: Jack Dorsey predicted most companies would follow Block's AI-driven restructuring within a year. Mark Zuckerberg did not wait the month. What the CEO agent race means for every business with layers between decisions and data.
<div class="stat-row">
    <div class="stat">
        <span class="stat-number">24</span>
        <span class="stat-label">Days between Dorsey's cut and Zuckerberg's agent</span>
    </div>
    <div class="stat">
        <span class="stat-number">18</span>
        <span class="stat-label">Months Goose ran in production before Block acted</span>
    </div>
    <div class="stat">
        <span class="stat-number">$2B</span>
        <span class="stat-label">What Meta paid for Manus because they did not have a Goose</span>
    </div>
</div>
The Timeline
...
<div class="flow-block">
    <div class="flow-step">
        <span class="flow-number">Feb 26</span>
        <span class="flow-text"><strong>Block cuts 4,000 employees.</strong> Dorsey cites intelligence tools. Stock jumps 25%. Block's internal AI agent, Goose, has been running in production for 18 months.</span>
    </div>
    <div class="flow-step">
        <span class="flow-number">Mar 11</span>
        <span class="flow-text"><strong>Atlassian cuts 1,600.</strong> CEO says it would be disingenuous to pretend AI does not change the number of roles required. Stock goes up.</span>
    </div>
    <div class="flow-step">
        <span class="flow-number">Mar 14</span>
        <span class="flow-text"><strong>Reuters reports Meta planning 20% workforce reduction.</strong> Up to 16,000 people. Stock climbs 3% on the news.</span>
    </div>
    <div class="flow-step">
        <span class="flow-number">Mar 17</span>
        <span class="flow-text"><strong>Meta launches Manus desktop agent.</strong> The $2 billion acquisition deploys a personal AI agent that operates directly on users' computers.</span>
    </div>
    <div class="flow-step">
        <span class="flow-number">Mar 22</span>
        <span class="flow-text"><strong>Wall Street Journal reports Zuckerberg is building a personal AI agent to help him be CEO.</strong> The agent retrieves information he would normally have to go through layers of people to get.</span>
    </div>
</div>
...
<div class="stack-block">
    ...
    <div class="stack-item">
        <span class="stack-tool">Goose</span>
        <span class="stack-role">Built internally, open-sourced, running in production since mid-2024.</span>
    </div>
    <div class="stack-item">
        <span class="stack-tool">40% increase</span>
        <span class="stack-role">Code shipped per engineer, measured over 18 months of production use.</span>
    </div>
    <div class="stack-item">
        <span class="stack-tool">Cut 4,000</span>
        <span class="stack-role">With data in hand. Gross profit per employee projected to double to $2 million.</span>
    </div>
    <div class="stack-item">
        <span class="stack-tool">Flattened the org</span>
        <span class="stack-role">Eliminated layers between teams and decisions.</span>
    </div>
</div>
<div class="stack-block">
    <h3>Zuckerberg / Meta</h3>
    <div class="stack-item">
        <span class="stack-tool">Manus</span>
        <span class="stack-role">Bought for $2 billion. Also acquired Moltbook. Building a personal CEO agent. Still in development.</span>
    </div>
    <div class="stack-item">
        <span class="stack-tool">Performance reviews</span>
        <span class="stack-role">AI adoption is now a factor in employee evaluations. Tutorials several times a week.</span>
    </div>
    <div class="stack-item">
        <span class="stack-tool">Planning 20% cuts</span>
        <span class="stack-role">CFO says she worries about keeping up with AI-native startups.</span>
    </div>
    <div class="stack-item">
        <span class="stack-tool">50 ICs per manager</span>
        <span class="stack-role">New applied AI org designed to be "AI native from day one."</span>
    </div>
</div>
...
<div class="pullquote">The difference between Dorsey and everyone else is not that he saw it first. It is that he moved first.</div>
The CEO Agent
...
Meta's CFO, Susan Li, said something at a conference earlier this month that tells you everything about the internal pressure driving this. She said she thinks a lot about making sure Meta does not work any less efficiently than companies that were AI native from day one. (Sound familiar to Goose at Block?)
...
The question stopped being whether AI replaces jobs the moment Zuckerberg started building an AI clone of himself to do his own job faster. The question now is how quickly the tools built for trillion-dollar companies show up at your front counter.  And the rumors of Mark being a robot, will continue to grow.
