...
category: Field Note
slug: three-percent
lede: A survey asked 600 restaurant operators where AI could deliver the most value. 38% said scheduling and labor. 3% said dashboards. Everyone keeps talking about the 38. The 3% is the number that tells us more.
---

<div class="stat-row">
    <div class="stat">
        <span class="stat-number">38%</span>
        <span class="stat-label">Want AI for scheduling & labor</span>
    </div>
    <div class="stat">
        <span class="stat-number stat-hero">3%</span>
        <span class="stat-label">Want AI for dashboards & reporting</span>
    </div>
</div>
...
<div class="pullquote">The 3% is not a vote against data. It is a vote against the delivery model. GMs do not want to go find information. They want information to find them.</div>
